...
class ShiftHit_test : public QObject {
    ...
    private:
        void paint( const std::vector<PointF>& points, const std::string& filename );
...
void ShiftHit_test::paint( const std::vector<PointF>& points, const std::string& filename ) {
    ...
    image.fillColor( "red" );
    image.draw( Magick::DrawableRectangle( center.x(), center.y(), center.x() + 5, center.y() + 5 ) );
